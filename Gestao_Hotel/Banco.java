...
public class Banco {
    ...
    private List<Funcionario> bdFuncionario = new ArrayList<Funcionario>();
    private List<Cliente> bdCli = new ArrayList<Cliente>();
    private List<Produto> bdProduto = new ArrayList<Produto>();
    ...
    public String quartosDisponiveis() {
        ...
        return quartosDisp.isEmpty() ? "" : quartosDisp;
    }
}